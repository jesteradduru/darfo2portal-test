/*
  Modal Form for editing roles and permissions under roles module.
*/
...
const EditRoleModal = ({ isModalOpen, toggleModal, roleData }) => {
  ...
  const onFormSubmit = async (e) => {
    ...
    if (!isRoleNameTaken) {
      await dispatch(updateRole(role_permissions_data)).then(() => {
        toggleModal();
        dispatch(getRoles());
      });
    }
